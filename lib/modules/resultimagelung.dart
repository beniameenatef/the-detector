...
class resultimagelung extends StatefulWidget {
  resultimagelung({Key? key}) : super(key: key);

  @override
  home createState() => home();
}

class home extends State<resultimagelung> {
  TextEditingController edit = TextEditingController();

  // late Future<Year> year;
  late Future<lungimageresult> imagelungresult;

  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    imagelungresult = Gitlungimageresult();
  }
